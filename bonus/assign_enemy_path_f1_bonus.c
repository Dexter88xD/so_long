...
/*   Updated: 2025/02/06 06:22:41 by sohamdan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	assign_right_e_side_fone(t_places *e_r)
{
	...
	(*e_r).one.ptr_r = "assets/N/look_r/side/one/right/frame_1.xpm";
	(*e_r).one.ptr_u = "assets/N/look_r/side/one/up/frame_1.xpm";
	(*e_r).three.ptr_d = "assets/N/look_r/side/three/down/frame_1.xpm";
	(*e_r).three.ptr_l = "assets/N/look_r/side/three/right/frame_1.xpm";
	(*e_r).three.ptr_r = "assets/N/look_r/side/three/left/frame_1.xpm";
	(*e_r).three.ptr_u = "assets/N/look_r/side/three/up/frame_1.xpm";
	(*e_r).two.ptr_u_d = "assets/N/look_r/side/two/left_right/frame_1.xpm";
