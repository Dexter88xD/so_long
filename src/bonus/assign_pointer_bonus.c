...
/*   Updated: 2025/02/04 18:01:32 by sohamdan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	(*a).wall.cor.img_l_d = mlx_xpm_file_to_image(mlx_ptr, (*a).wall.cor.ptr_l_d,
		x, y);
	(*a).wall.cor.img_l_u = mlx_xpm_file_to_image(mlx_ptr, (*a).wall.cor.ptr_l_u,
		x, y);
	(*a).wall.cor.img_r_u = mlx_xpm_file_to_image(mlx_ptr, (*a).wall.cor.ptr_r_u,
		x, y);
	(*a).wall.cor.img_r_d = mlx_xpm_file_to_image(mlx_ptr, (*a).wall.cor.ptr_r_d,
		x, y);
	(*a).wall.one.img_l = mlx_xpm_file_to_image(mlx_ptr, (*a).wall.one.ptr_l, x, y);
	(*a).wall.one.img_r = mlx_xpm_file_to_image(mlx_ptr, (*a).wall.one.ptr_r, x, y);
	(*a).wall.one.img_u = mlx_xpm_file_to_image(mlx_ptr, (*a).wall.one.ptr_u, x, y);
	(*a).wall.one.img_d = mlx_xpm_file_to_image(mlx_ptr, (*a).wall.one.ptr_d, x, y);
...
{
	(*key).middle.img = mlx_xpm_file_to_image(mlx_ptr, (*key).middle.ptr, x,
			y);
	(*key).cor.img_l_d = mlx_xpm_file_to_image(mlx_ptr, (*key).cor.ptr_l_d,
			x, y);
	(*key).cor.img_l_u = mlx_xpm_file_to_image(mlx_ptr, (*key).cor.ptr_l_u,
			x, y);
	(*key).cor.img_r_d = mlx_xpm_file_to_image(mlx_ptr, (*key).cor.ptr_r_d,
			x, y);
	(*key).cor.img_r_u = mlx_xpm_file_to_image(mlx_ptr, (*key).cor.ptr_r_u,
			x, y);
}