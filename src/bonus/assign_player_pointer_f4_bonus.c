...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   assign_player_pointer_f4_bonus.c                   :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: sohamdan <sohamdan@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/01/30 11:57:19 by sohamdan          #+#    #+#             */
/*   Updated: 2025/02/04 09:39:45 by sohamdan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "so_long.h"

void	point_right_p_middle_corner_ffour(t_places *p_r, void *mlx_ptr, int *x,
		int *y)
{
...
void	point_left_p_middle_corner_ffour(t_places *p_l, void *mlx_ptr, int *x,
		int *y)
{
